...
import EditService from "../../components/Segment/Edit.vue";
import AddService from "../../components/Segment/Add.vue";
import Confirm from "../../components/Shared/Confirm.vue";
import useLanguage from "src/composables/useLanguage";

const { all } = useLanguage();
const { loading, columns, items, trash, paginate } = useSegment();
const {
  showAdd,
  showEdit,
  selected,
