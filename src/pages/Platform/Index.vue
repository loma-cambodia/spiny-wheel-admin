...
import EditService from "../../components/Platform/Edit.vue";
import AddService from "../../components/Platform/Add.vue";
import Confirm from "../../components/Shared/Confirm.vue";
import useLanguage from "src/composables/useLanguage";

const { all } = useLanguage();
const { loading, columns, items, trash, paginate } = usePlatfrom();
const {
  showAdd,
  showEdit,
  selected,
