  ...
  >
    ...
    <q-card-section class="q-pt-lg">
      <q-input
        ...
        lazy-rules
        :rules="[
          val => !!val || $t(Utils.getKey('the name field is required!')),
    ...
    <q-card-section class="q-pt-none">
      <q-input
        ...
        lazy-rules
        :rules="[
          val => !!val || $t(Utils.getKey('the locale field is required!')),
    ...
    <q-card-section class="q-pt-none">
      <q-input
        ...
        lazy-rules
        :rules="[
          val => !!val || $t(Utils.getKey('The locale web field is required!')),
          val =>  Utils.containsOnlyCharacterAllLanguage(val) || $t(Utils.getKey('only character')),
        ]"
      />
    </q-card-section>
  ...
  try {
    if (
      ...
      $q.notify({
        ...
        message: t(Utils.getKey(message)),
      });
      return;
    }
